...
var resizeImage = function (query) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                _a.trys.push([0, 2, , 3]);
                return [4 /*yield*/, (0, sharp_1.default)("assets/images/".concat(query.target, ".png").toString())
                        .resize({
                        width: parseInt(query.width),
                        height: parseInt(query.height),
                    })
                        .toFile("assets/thumb/".concat(query.target, "_").concat(query.width, "x").concat(query.height, ".png").toString())];
            case 1:
